        ...
        <section className="home-slider">
            <div className="slider-container">
                <div className="slider-text-content">
                    ...
                    <h2>Only for RS. 250</h2>
                </div>
                <div className={index?'slider-content':'slider-content active'} style={{backgroundImage:'url(https://www.restaurant-mahlberg.de/wp-content/uploads/2020/02/Burger-Banner.jpg'}}>
                </div>
