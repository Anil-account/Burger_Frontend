    ...
    return (
      <div className="product1-rating">
        {ratingstar.map((value, idx) => {
          if (average - idx >= 1) {
            return <i key={idx} className="fa fa-star"></i>;
          }
            ...
            <div className="row">
              ...
              <div className="col-md-7">
                <div className="product1-body">
                  ...
                  <h3 className="product1-price">
                    Price:{" "}
                    RS. {String(detailProduct.price).replace(
                      /(.)(?=(\d{3})+$)/g,
                      "$1."
                    )}
                  ...
                  <div>
                    <div className="product1-rating">{averageRate()}</div>
                    <span className="link-detail" to="#">
                      {reviewCount.length} Comment
                    </span>
                  </div>
                  <p>
                    <strong>Status:</strong> avaliable
                  </p>
                  <p>
                    <strong>Sold: </strong>
                    {detailProduct.sold}
                  ...
                  <div className="tab-content">
                    <div id="tab2" className="tab-pane active">
                      <div className="row">
                        ...
                        <div className="col-md-6">
                          <h4 className="text-uppercase">YOur commeent:</h4>
                          <p>Your email address will be hidden.</p>
