...
function Header() {
  ...
  const setCategory = state.productApi.category[1];
    ...
    return (
      <>
        <ul className="ul-logged">
          <li className="li-logged">
            <Link to="/create_product">Product</Link>
          </li>
          <li className="li-logged">
    ...
    <div className="header">
      <div className="header-mobile">
        <div className="header-mobile-row1">
          <div className="header-mobile-row1__wrap">
          ...
          <div className="header-mobile-row1__wrap">
            <div className="header-mobile-home">
              <Link to="/" onClick={() => setCategory("")}>
                ...
                <span className="header-mobile-row2-span">Home</span>
              </Link>
            </div>
            <div className="header-mobile-login">
              {isLogged ? (
                <Link to="/logout" onClick={logoutUser}>
                  ...
                  <span className="header-mobile-row2-span">Logout</span>
                </Link>
              ) : (
                <Link to="/login">
                  <i className="fas fa-user"></i>
                  <span className="header-mobile-row2-span">Login</span>
                </Link>
              )}
            </div>
            {isLogged & !isAdmin ? (
              <div className="header-mobile-login">
                <Link to="/history">
                  ...
                  <span className="header-mobile-row2-span">History</span>
                </Link>
              </div>
            ) : (
              <></>
          ...
          <div className="header-row2">
            ...
            <ul className="menu__list">
              <li className="menu__item">
                <Link
                  to="/"
                  onClick={() =>
                    setCategory("category=610b4d68a454d13edc92a36d")
                  }
                >
                  <span className="menu__title-wrap">
                    <svg
                      viewBox="0 0 137 137"
                      id="svg-icon-9"
                      fill="inherit"
            ...
            <div className="header-btn">
              <div className="header__search-btn">
                                <Link to="/">
                                    <svg viewBox="0 0 18 17" id="svg-search" fill="inherit" stroke="inherit"><path fillRule="evenodd" clipRule="evenodd" d="M13.7344 11.1283C14.3841 10.0294 14.757 8.7475 14.757 7.37848C14.757 3.30346 11.4535 0 7.37848 0C3.30346 0 0 3.30346 0 7.37848C0 11.4535 3.30346 14.757 7.37848 14.757C9.26218 14.757 10.981 14.0511 12.2849 12.8894L16.1553 16.7598L17.7607 15.1545L13.7344 11.1283ZM12.4867 7.37848C12.4867 10.1997 10.1997 12.4867 7.37848 12.4867C4.55731 12.4867 2.2703 10.1997 2.2703 7.37848C2.2703 4.55731 4.55731 2.2703 7.37848 2.2703C10.1997 2.2703 12.4867 4.55731 12.4867 7.37848Z" fill="inherit" stroke="none"></path></svg>
                                </Link>
                            </div>
              <div className="header__cart-btn header-mobile-cart">
                <Link to="/cart">
                  <svg
                    viewBox="0 0 18 18"
                    id="svg-cart"
      ...
      <div className="side__menu">
        <div
          className={`side__menu-shadow ${menu ? "open" : ""}`}
          onClick={toggleMenu}
        ></div>
        <div className={`side__menu-wrap ${menu ? "open" : ""}`}>
          <div className="side__menu-button">
            <div onClick={toggleMenu} className="side__menu-btn-close">
              <i className="fas fa-times"></i>
            </div>
          </div>
          <div className="side__menu-content">
            <ul className="side-menu__list">
              <li className="side-menu__item">
                <Link
                  ...
                  onClick={() => {
                    toggleMenu();
                    setCategory("category=610b4a5a0558233eb4481676");
                  }}
                >
                  <span className="menu__title-wrap">
                    <svg
              ...
              <li className="side-menu__item">
                <Link
                  ...
                  onClick={() => {
                    toggleMenu();
                    setCategory("category=610b4c7613cbeb26cc5dada8");
                  }}
                >
                  <span className="menu__title-wrap">
                    <svg
              ...
              <li className="side-menu__item">
                <Link
                  ...
                  onClick={() => {
                    toggleMenu();
                    setCategory("category=6114f0121433aa4d5c1f3e5f");
                  }}
                >
                  <span className="menu__title-wrap">
                    <svg
              ...
              <li className="side-menu__item">
                <Link
                  ...
                  onClick={() => {
                    toggleMenu();
                    setCategory("category=6114f0481433aa4d5c1f3e63");
                  }}
                >
                  <span className="menu__title-wrap">
                    <svg
              ...
              <li className="side-menu__item">
                <Link
                  ...
                  onClick={() => {
                    toggleMenu();
                    setCategory("category=6114f0511433aa4d5c1f3e67");
                  }}
                >
                  <span className="menu__title-wrap">
                    <svg
